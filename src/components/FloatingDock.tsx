...
const socialLinks = [
  ...
  },
  {
    ...
    href: "https://linkedin.com/in/valtrizt",
    name: "LinkedIn",
  },
  {
    icon: <FontAwesomeIcon icon={faInstagram} />,
    href: "https://instagram.com/valtrizt",
    name: "Instagram",
  },
  {
    icon: <FontAwesomeIcon icon={faMedium} />,
    href: "https://medium.com/@valvaltrizt",
    name: "Medium",
  },
  {
    icon: <Mail size={24} />,
    href: "https://mail.google.com/mail/u/0/?source=mailto&to=valvaltrizt@gmail.com&fs=1&tf=cm",
    name: "Gmail",
  },
  {
    icon: <File size={24} />,
    href: "https://drive.google.com/drive/folders/1N9YmbvgpbAzwr7J-d_M8RLoicMI95OIc?usp=sharing",
    name: "CV",
  },
];
...
function SocialIcon({
  ...
  const distance = useTransform(mouseX, (val) => {
    if (typeof window !== "undefined") {
      const bounds = document.getElementById(name)?.getBoundingClientRect() ?? {
        x: 0,
        width: 0,
      };
